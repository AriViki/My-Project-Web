                    ...
                    <div class="col-md-5">
                        ...
                        <div class="col mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-2" name="username" id="username" value="<?= $user['username']; ?>">
                            </div>
                        </div>
                        <div class="col mb-3">
                            <div class="form-group">
                                <label for="alamat_user">Alamat</label>
                                <input type="text" class="form-control mt-2" name="alamat_user" id="alamat_user" value="<?= $user['alamat_user']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        ...
                        <div class="col mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" pattern="^\d{12}$" class="form-control mt-2" name="no_hp_user" id="no_hp_user" value="<?= $user['no_hp_user']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10">
